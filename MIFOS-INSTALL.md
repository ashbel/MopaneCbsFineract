...
## 2. Amazon Public AMI
 ...
 - Java 21 LTS 64 bit JVM (Java 25 when available)
 - Tomcat 7.0.68 
 - MySql 5.5.47
...
### 3.1 Prerequisite Software
  ...
  - Oracle Java - JDK 21 LTS (JDK 25 when available) (http://www.oracle.com/technetwork/java/javase/downloads/index.html)
