...
public class OfficeWorkbookPopulator extends AbstractWorkbookPopulator {
    ...
    private void setLayout(final Sheet worksheet){
        ...
        worksheet.setColumnWidth(OfficeConstants.SHORT_CODE_COL, TemplatePopulateImportConstants.SMALL_COL_SIZE);
        ...
        writeString(OfficeConstants.SHORT_CODE_COL, rowHeader, "Short Code*");
