...
public class SsbPayBatchData {
    ...
    private List<SsbPayRowData> rows = new ArrayList<>();
    ...
    public List<SsbPayRowData> getRows() {
        return rows;
    }

    public void setRows(final List<SsbPayRowData> rows) {
        this.rows = rows;
    }
}
