...
public class AccountDetailsReadPlatformServiceJpaRepositoryImpl implements AccountDetailsReadPlatformService {
    ...
    public AccountDetailsReadPlatformServiceJpaRepositoryImpl(final ClientReadPlatformService clientReadPlatformService,
            ...
            final ColumnValidator columnValidator,final LoanRepositoryWrapper loanRepositoryWrapper) {
    ...
    private List<LoanAccountSummaryData> retrieveLoanAccountDetails(final String loanwhereClause, final Object[] inputs) {
        final LoanAccountSummaryDataMapper rm = new LoanAccountSummaryDataMapper(loanRepositoryWrapper);
    ...
    private static final class LoanAccountSummaryDataMapper implements RowMapper<LoanAccountSummaryData> {
    	...
    	public LoanAccountSummaryDataMapper() {
    		
    	}
    	//Constructor to inject Accrued Interest from retrieveOne(long) method
    	public LoanAccountSummaryDataMapper(LoanRepositoryWrapper loanRepositoryWrapper) {
    		this.loanRepositoryWrapper = loanRepositoryWrapper;
    	}
		...
		public String loanAccountSummarySchema() {
            ...
            accountsSummary
                    ...
                    .append(" l.principal_outstanding_derived as principalOutstanding,")
                    .append(" la.interest_overdue_derived as interestOverdue,")
