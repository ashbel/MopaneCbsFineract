...
//            Collection<DisbursementData> disbursementData, boolean isInterestRecalculationEnabled, BigDecimal totalPaidFeeCharges);
	...
	Page<LoanTransactionData> retrieveAllTransactions(SearchParameters searchParameters);

	LoanTransactionData retrieveLastLoanTransactions(Long loanId);

	LoanScheduleData retrieveRepaymentScheduleWithCapitalisation(Long loanId,
			RepaymentScheduleRelatedLoanData repaymentScheduleRelatedLoanData,
			Collection<DisbursementData> disbursementData, LoanAccountData loanAccountData);

	Collection<LoanChargeData> retrieveLoanDisbursementCharges(Long loanId);
	...
	LoanScheduleData retrieveRepaymentSchedule(Long loanId,
			...
			BigDecimal totalPaidFeeCharges, Collection<LoanChargeData> loanChargeData);
