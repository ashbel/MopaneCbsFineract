...
public final class LoanSummary {
    ...
    public void updateSummary(final MonetaryCurrency currency, final Money principal,
    	...
    	//Changed this to take into account what's in the schedule for cap fees
    	BigDecimal principalDisbursed = summaryWrapper.calculateTotalPrincipalDisbursed(repaymentScheduleInstallments, currency).getAmount();
        ...
        this.totalPrincipalOutstanding = principalDisbursed.subtract(this.totalPrincipalRepaid).subtract(this.totalPrincipalWrittenOff);
...
//                .minus(this.totalInterestWrittenOff).getAmount();
        ...
        this.totalInterestOutstanding = summaryWrapper.calculateTotalInterestOverdueOn(repaymentScheduleInstallments, currency, DateUtils.getLocalDateOfTenant()).getAmount();
