        ...
        switch (type) {
            ...
            case REPAYMENT_AT_DISBURSEMENT:
                optionData = new LoanTransactionEnumData(LoanTransactionType.REPAYMENT_AT_DISBURSEMENT.getValue().longValue(),
                        LoanTransactionType.REPAYMENT_AT_DISBURSEMENT.getCode(), "Disbursement Fee");
            break;
            case CONTRA:
            ...
            case ACCRUAL:
                optionData = new LoanTransactionEnumData(LoanTransactionType.ACCRUAL.getValue().longValue(),
                        LoanTransactionType.ACCRUAL.getCode(), "Interest Charged");
            break;
            case FEE:
                optionData = new LoanTransactionEnumData(LoanTransactionType.FEE.getValue().longValue(),
                        LoanTransactionType.FEE.getCode(), "Fees Charged");
            break;
