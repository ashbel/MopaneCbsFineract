...
public class LoansApiResource {
    ...
    public String retrieveLoan(@PathParam("loanId") final Long loanId,
        ...
        Collection<LoanChargeData> loanChargeData = null;
        ...
        if (!associationParameters.isEmpty()) {
            ...
            if (associationParameters.contains("multiDisburseDetails") || associationParameters.contains("repaymentSchedule")) {
                ...
                loanChargeData = this.loanReadPlatformService.retrieveLoanDisbursementCharges(loanId);
            }
        ...
        //Adding Upfront Charges to Loan
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public String retrieveAllTransactions(@Context final UriInfo uriInfo,
            @QueryParam("sqlSearch") final String sqlSearch,
            @QueryParam("externalId") final String externalId,
            // @QueryParam("underHierarchy") final String hierarchy,
            @QueryParam("offset") final Integer offset, @QueryParam("limit") final Integer limit,
            ...
            @QueryParam("accountNo") final String accountNo)
    {
        ...
        final Page<LoanTransactionData> loanTransactionDetails = this.loanReadPlatformService.retrieveAllTransactions(searchParameters);

        final ApiRequestJsonSerializationSettings settings = this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
        return this.tranApiJsonSerializer.serialize(settings, loanTransactionDetails, this.LOAN_DATA_PARAMETERS);
    }
