...
public enum LoanTransactionType {
    ...
    //Disbursement Fees
    FEE(20, "loanTransactionType.fee"),//;
	CAPITALIZED_FEE(21, "loanTransactionType.capfee"),//;
	DEDUCTED_FEE(22, "loanTransactionType.dedfee");//;
    ...
    public static LoanTransactionType fromInt(final Integer transactionType) {
        ...
        switch (transactionType) {
            ...
            case 19:
            	...
            	break;
            case 20:
            	loanTransactionType = LoanTransactionType.FEE;
            	break;
            case 21:
            	loanTransactionType = LoanTransactionType.CAPITALIZED_FEE;
            	break;
            case 22:
            	loanTransactionType = LoanTransactionType.DEDUCTED_FEE;
            	break;
            default:
    ...
    public boolean isDeductedFee() {
        return this.value.equals(LoanTransactionType.DEDUCTED_FEE.getValue());
    }
}