...
public enum ChargeTimeType {
	...
	DISBURSEMENT_CAPITALISED(17,"chargeTimeType.disbursementCapitalized");
    ...
    public static Object[] validLoanValues() {
        return new Integer[] { ChargeTimeType.DISBURSEMENT.getValue(),ChargeTimeType.DISBURSEMENT_CAPITALISED.getValue(), ChargeTimeType.SPECIFIED_DUE_DATE.getValue(),
    ...
    public static ChargeTimeType fromInt(final Integer chargeTime) {
        ...
        if (chargeTime != null) {
            switch (chargeTime) {
                ...
                break;
                case 17:
                	chargeTimeType = DISBURSEMENT_CAPITALISED;
                break;
                default:
    ...
    public boolean isTimeOfDisbursement1() {
        return ChargeTimeType.DISBURSEMENT.getValue().equals(this.value);
    }
    
    public boolean isTimeOfDisbursementCapitalised() {
        return ChargeTimeType.DISBURSEMENT_CAPITALISED.getValue().equals(this.value);
    }
    ...
    public boolean isAllowedLoanChargeTime() {
        return isTimeOfDisbursement() || isOnSpecifiedDueDate() || isInstalmentFee() || isOverdueInstallment() || isTrancheDisbursement() || isTimeOfDisbursementCapitalised();
    }
