        ...
        switch (type) {
            case DISBURSEMENT:
                optionData = new EnumOptionData(ChargeTimeType.DISBURSEMENT.getValue().longValue(), ChargeTimeType.DISBURSEMENT.getCode(),
                        "Disbursement");
            break;
            case DISBURSEMENT_CAPITALISED:
                optionData = new EnumOptionData(ChargeTimeType.DISBURSEMENT_CAPITALISED.getValue().longValue(), ChargeTimeType.DISBURSEMENT_CAPITALISED.getCode(),
                        "Disbursement Capitalised");
            break;
