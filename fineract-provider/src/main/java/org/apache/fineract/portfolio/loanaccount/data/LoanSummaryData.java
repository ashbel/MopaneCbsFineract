...
public class LoanSummaryData {
    ...
    public LoanSummaryData(final CurrencyData currency, final BigDecimal principalDisbursed, final BigDecimal principalPaid,
            ...
            final LocalDate overdueSinceDate,final Long writeoffReasonId,final String writeoffReason,final BigDecimal interestAccrued) {
    ...
    public BigDecimal getTotalLoanOutstanding() {
        return principalOutstanding.add(feeChargesOverdue).add(interestOverdue).add(penaltyChargesOverdue);
    }
}