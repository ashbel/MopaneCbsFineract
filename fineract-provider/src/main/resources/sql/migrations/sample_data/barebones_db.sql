...
-- ---------------------------------------------------------------------------
-- Mopane RBZ FORM_MFI1 seed (all MFIs use the same regulatory report)
-- Source of truth also: sample_data/rbz_form_mfi1_seed.sql
-- Mirrored by Flyway: core_db/V5004__rbz_form_mfi1_codes_and_datatables.sql
-- ---------------------------------------------------------------------------
