...
ALTER TABLE `m_loan`
ADD INDEX `m_loan_expected_disbursedon_date_status_idx` (`expected_disbursedon_date` ASC, `loan_status_id` ASC) ALGORITHM=INPLACE, LOCK=NONE;
...
ADD INDEX `m_loan_transaction_date_type_reversed_idx` (`transaction_date` ASC, `transaction_type_enum` ASC, `is_reversed` ASC) ALGORITHM=INPLACE, LOCK=NONE;
...
ADD INDEX `m_office_hierarchy_idx` (`hierarchy` ASC) ALGORITHM=INPLACE, LOCK=NONE;
